...
ENV['MYCLI_EXAMPLES'] = File.expand_path('../examples/', __dir__)
...
RSpec.configure do |config|
  config.before(:suite) do
    primary_config = File.join(__dir__, 'fixtures', 'primary_config.yaml')
    MyCLI::Config.instance.load_config(primary_config)
  end
